 ...
 * y los translada a géneros estandar del sistema. Calcula el peso de cada
 * género estandar para cada disco.
 * 
...
public class PonderacionDAlbum implements IPonderacion, IOperacion {
    ...
    /**
     * Función que agrupa las operaciones para estandarizar y ponderar
     ...
     * desde los tracks del album o, en última instancia, del artista.
     * 
    ...
    /**
     * Estandariza un tag simple. Comprueba que el tag está en la lista
     * de géneros del archivo de propiedades y lo devuelve.
     * 
     * @param String
     * @return String
     * */
    ...
    /**
     * Calcula los pesos de los géneros.
     * El peso de cada género se recalcula en función del número de
     * géneros que tiene el album.
     * 
     * Ng = Número de géneros
     * Na = Número apariciones de un género en el album
     * Pu = Peso unidad de aparición
     * Pg = Peso de género
     * 
     * Pu = 1 / Ng
     * Pg = Na * Pu
