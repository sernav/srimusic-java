...
public class XMLUtil {
	...
	/**
	 * Método para devolver un archivo tipo Document a partir de un XML con SAX
	 * 
	...
	/**
	 * Método para devolver un archivo tipo Document apartir de un XML con DOM
	 * 
	 * @param nombre del XML a cargar
	 * @return Document
	 * */
	...
	/**
	 * Método para devolver un archivo tipo Document apartir de una cadena
	 * 
	...
	/**
	 * Añadir un nuevo elemento al documento XML
	 * 
	 * @param Documento XML (Document)
